...
codeunit 149005 "BCPT Line"
{
    ...
    begin
        ...
        AddLogEntry(BCPTLine, ScenarioOperation, ExecutionSuccess, ErrorMessage, StartTime, EndTime);
    end;

    procedure AddLogEntry(var BCPTLine: Record "BCPT Line"; Operation: Text; ExecutionSuccess: Boolean; Message: Text; StartTime: DateTime; EndTime: Datetime)
    var
        BCPTLogEntry: Record "BCPT Log Entry";

...
codeunit 149000 "BCPT Start Tests"
{
    ...
    procedure StartBCPTSuite(var BCPTHeader: Record "BCPT Header")
    var
    ...
    procedure StopBCPTSuite(var BCPTHeader: Record "BCPT Header")
    begin
    ...
    procedure StartNextBenchmarkTests(BCPTHeader: Record "BCPT Header")
    var
        BCPTHeader2: Record "BCPT Header";
        BCPTLine: Record "BCPT Line";
    begin

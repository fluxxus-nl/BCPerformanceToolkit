...
codeunit 149002 "BCPT Role Wrapper"
{
    ...
    procedure GetScenarioLbl(): Text[100]
    begin
        exit(ScenarioLbl);
    end;

    // internal procedure GetBCPTHeaderTag(): Text[20]
    procedure GetBCPTHeaderTag(): Text[20]
    begin
        exit(BCPTHeader.Tag);
    end;
    ...
    procedure GetBCPTLine(var BCPTLine: Record "BCPT Line")
    begin
    ...
    procedure GetBCPTHeader(var CurrBCPTHeader: Record "BCPT Header")
    begin
    ...
    procedure GetAndClearNoOfLogEntriesInserted(): Integer
    var
        ReturnValue: Integer;
    begin
        ReturnValue := NoOfInsertedLogEntries;
